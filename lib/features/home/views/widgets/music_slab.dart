...
class MusicSlab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      onTap: () {
        // NOTED
        // in order we are using go_router
        // We can use this : context.goNamed(MusicPlayer.routeName, extra: current)
        // but the problem is we implement nested navigation bar
